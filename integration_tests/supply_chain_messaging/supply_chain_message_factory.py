...
from addressing.supply_chain_addressers import addresser as addressing
...
class SupplyChainMessageFactory:
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            ...
            family_version=addressing.FAMILY_VERSION,
            namespace=addressing.NAMESPACE,
            signer=signer)

        self.public_key = self._factory.get_public_key()
        self.signer_address = addressing.get_agent_address(self.public_key)
    ...
    def create_record_type(self, name, *properties):
        ...
        record_type_address = addressing.get_record_type_address(name)
    ...
    def create_record(self, record_id, record_type, properties_dict):
        ...
        record_address = addressing.get_record_address(record_id)
        record_type_address = addressing.get_record_type_address(record_type)
    ...
    def create_proposal(self, record_id, receiving_agent,
        ...
        receiving_address = addressing.get_agent_address(receiving_agent)
    ...
    def make_empty_payload(self, public_key):
        address = addressing.get_agent_address(public_key)
